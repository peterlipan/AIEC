...
if __name__ == '__main__':
    ...
    parser.add_argument('--dst', type=str, default='/mnt/zhen_chen/patches_CAMELYON16_DTFD_x20_down_2_4')
    parser.add_argument('--patch_size', type=int, default=256)
    parser.add_argument('--base_downsample', type=int, default=2)
    # default downsample factors: 2, 5
    # equals to magnifications: x40, x20, x4
    parser.add_argument('--downsample_factor', type=str, default="2,4")
